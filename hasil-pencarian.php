                    ...
                    <div class="single-features-area mb-50">
                        ...
                        <div class="feature-content d-flex align-items-center justify-content-between">
                            <div class="feature-title">
                                <h5><?= $r['tujuan']; ?></h5>
                                <p>
                                  Tanggal Berangkat: <b><?= indonesian_date_only($r['tgl_berangkat']); ?></b><br/>
                                  ...
                                  Kursi Tersedia: <b><?= $r['jml_kursi']; ?> Kursi</b><br/>
								                </p>
                								<div class="feature-favourite">
                                                <a href="#"><?= rupiah($r['total']); ?></a>
                								</div>
                                <p>*<i><small>Jika ingin memesan, Anda harus mendaftar/login terlebih dahulu.</small></i></p>
                            </div>
                        </div>
                    </div>
                </div>
  ...
  ?>
                <div class="col-12 col-sm-12 col-lg-12">
                    <div class="feature-title">
                        ...
                        <center><a href="./" class="btn btn-success"><i class="fa fa-bus" aria-hidden="true"></i> Kembali Ke Pemesanan</a></center>
                    </div>
                </div>
  <?php
}
