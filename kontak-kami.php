...
<head>
    ...
    <!-- Title -->
    <title>Kontak Kami - P.O Budiman</title>
...
<body>
    ...
    <div class="breadcumb-area bg-img bg-overlay" style="background-image: url(img/busbudiman.jpg)">
    </div>
    <!-- ***** Breadcumb Area End ***** -->
    ...
    <div class="dorne-contact-area d-md-flex" id="contact">
        ...
        <div class="contact-form-area equal-height">
            <div class="contact-text">
                <h4>Ada yang ditanyakan?</h4>
                <p>Silahkan hubungi kami kapanpun dan dimanapun terkait pemesanan bus dan info tentang tujuan kami.</p>
