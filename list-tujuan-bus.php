...
$query = mysqli_query($kon, "select jadwal_keberangkatan.*, kendaraan.* from jadwal_keberangkatan join kendaraan on jadwal_keberangkatan.id_kendaraan=kendaraan.id_kendaraan order by jadwal_keberangkatan.id_jadwal") or die("Gagal query");
					...
					<img src="img/depok.jpeg" alt="" width="500" height="500">
                        ...
                        <div class="feature-content d-flex align-items-center justify-content-between">
                            <div class="feature-title">
                                ...
                                Jumlah Kursi: <b><?= $r['jml_kursi']; ?> Kursi</b><br/>

								<div class="feature-favourite">
                              <a href="#"><?= rupiah($r['harga']); ?> + <?= rupiah($r['harga_kelas']); ?>
								</div>
