...
<head>
    ...
    <title>Area <?php echo $jekel; ?><?php echo $_SESSION['nama_pelanggan'] ?></title>
    <!-- Bootstrap CSS -->
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Selamat Datang,  <?php echo $jekel; ?><?php echo $_SESSION['nama_pelanggan'] ?></h2>
                            <?php
