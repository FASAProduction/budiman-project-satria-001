...
$query = mysqli_query($connection, "SELECT transaksi.id_transaksi, transaksi.id_pesan, transaksi.foto, pesan.jml_penumpang, transaksi.tgl_transaksi, kendaraan.merek_kendaraan, kendaraan.kelas_kendaraan, jadwal_keberangkatan.tgl_berangkat, jadwal_keberangkatan.jam, tujuan.nama_tujuan
                                    FROM transaksi
                                    ...
                                    WHERE pesan.id_pelanggan='$_SESSION[id_pelanggan]'
...
<head>
    ...
    <title>Daftar Pesanan Bus Budiman</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-wrapper">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Berikut Daftar Transaksi Anda,
                                <?php echo $jekel; ?><?php echo $_SESSION['nama_pelanggan'] ?>.</h2>

                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Daftar
                                                Transaksi</a></li>
                                    </ol>
                                </nav>
                            </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p>Berikut adalah daftar transaksi Anda di P.O Bus Budiman |<small>
                                        <marquee behavior="scroll" width="600" onmouseover="this.stop()"
                                            onmouseout="this.start()">Pesanan akan otomatis batal jika tidak melakukan
                                            pembayaran lebih dari 1 hari. Untuk itu, segera lakukan pembayaran dan
                                            upload bukti bayar melalui tombol "Upload Bukti Bayar".</marquee>
                                    </small></p>
                            </div>
                            <div class="card-body">
            ...
            if ($data["foto"] == null) {
                ?>
                                                    <a href="modal.php?id_transaksi=<?php echo $data["id_transaksi"]; ?>&&id_pesan=<?php echo $data["id_pesan"]; ?>"
                                                        id="upload" class="btn btn-success btn-xs" data-toggle="modal"
                                                        data-target="#exampleModal" onclick="tampilkan()">Upload bukti
                                                        bayar</a>
                                                    <form onsubmit="return false" id="form" method="get">
                                                        <input type="hidden" class="form-control" id="transaksi"
                                                            name="id_transaksi"
                                                            value="<?php echo $data["id_transaksi"]; ?>">
                                                        <input type="hidden" class="form-control" id="pesan"
                                                            name="id_pesan" value="<?php echo $data["id_pesan"]; ?>">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel"><span
                                                                class="badge badge-primary"><i class="fas fa-bus"></i>
                                                                Upload Bukti Pembayaran</span></h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="../../dashboard/img/update-transaksi.php"
                                                            id="formUpload" class="foto" method="POST"
                                                            enctype="multipart/form-data">
                                                            <p>
                                                                Pembayaran dilakukan secara transfer ke rekening P.O
                                                                Budiman:<br /><br />
                                                                <img src="../../img/rekbni1.png" width="200"
                                                                    height="20"><br />
                                                                Atas Nama: <b>P.O Budiman</b>
                                                                <br />
                                                                <br />
                                                                <i><small>Batas waktu pengiriman paling lambat 1 hari
                                                                        setelah pemesanan.<br />
                                                                        Jika melebihi waktu tersebut, pelanggan
                                                                        dinyatakan batal dalam memesan.</small></i>
                                                            </p>
                                                            <br />

                                                            <input type="hidden" class="form-control" id="upTransaksi"
                                                                name="id_transaksi">
                                                            <input type="hidden" class="form-control" id="upPesan"
                                                                name="id_pesan">
                                                            <input type="file" class="form-control" id="foto"
                                                                name="foto" required=""><br />

                                                            <a href="#" class="btn btn-secondary"
                                                                data-dismiss="modal">Tutup</a>
                                                            <button type="submit" class="btn btn-rounded btn-success"
                                                                id="submit">Upload Bukti</button>
