                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Berikut Daftar Transaksi Anda,  <?php echo $jekel; ?><?php echo $_SESSION['nama_pelanggan'] ?>.</h2>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="../../dashboard/img/update-transaksi.php" id="formUpload" class="foto" method="POST" enctype="multipart/form-data">
                                                            <p>
                                                                ...
                                                                <br/>
                                                                <br/>
                                                                <i><small>Batas waktu pengiriman paling lambat 1 hari setelah pemesanan.<br/>
