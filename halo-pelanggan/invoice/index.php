                                ...
                                <div class="card-body">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <h3 class="text-dark mb-1"><?php echo $jekel; ?><?php echo $pesan['nama_pelanggan']; ?></h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div>
                      											<input type="hidden" class="form-control" name="id_transaksi" value="<?php echo $pesan['id_pesan']; ?>">
                      											<input type="hidden" class="form-control" name="id_pesan" value="<?php echo $pesan['id_pesan']; ?>">
                                            <input type="hidden" class="form-control" name="id_jadwal" value="<?php echo $pesan['id_jadwal']; ?>">
                                            <input type="hidden" class="form-control" name="jml_penumpang" value="<?php echo $pesan['jml_penumpang']; ?>">
                                        </div>
                                        <div>
