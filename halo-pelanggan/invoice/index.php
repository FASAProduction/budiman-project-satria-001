    ...
    <div class="dashboard-main-wrapper">
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown"
                                ...
                                <div class="nav-user-info">
                                    <h5 class="mb-0 text-white nav-user-name"><?php echo $_SESSION['nama_pelanggan'] ?>
                                    </h5>
        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid dashboard-content">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Berikut Detail Pesanan Anda,
                                <?php echo $_SESSION['nama_pelanggan'] ?>.</h2>
                            <?php
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Invoice
                                                Pemesanan</a></li>
                                    </ol>
                                </nav>
                            </div>
                ...
                $sql = mysqli_query($kon, "SELECT pesan.*, pelanggan.*, jadwal_keberangkatan.*, tujuan.*, SUM((tujuan.harga + kendaraan.harga_kelas) * pesan.jml_penumpang) as sub_total
                                           FROM pesan
                                           ...
                                           WHERE pesan.id_pelanggan='$_SESSION[id_pelanggan]'
                                                AND pesan.id_pesan = (SELECT MAX(id_pesan) FROM pesan)");
                    ...
                    <div class="offset-xl-2 col-xl-8 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header p-4">
                                <a class="pt-2 d-inline-block" href="../"><img src="../../img/budiman.png" width="100"
                                        height="50" /></a>

                                <div class="float-right">
                                    <h3 class="mb-0">Invoice No: <?php echo $pesan['id_pesan']; ?></h3>
                                    Tanggal: <?php echo indonesian_date($pesan['tgl_pesan']); ?>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <h3 class="text-dark mb-1">
                                            <?php echo $jekel; ?><?php echo $pesan['nama_pelanggan']; ?></h3>
                                        <div>Alamat: <?php echo $pesan['alamat']; ?></div>
                                        <div>Jenis Kelamin: <?php echo $pesan['jk']; ?></div>
                                        <div>Usia: <?php include '../function/umur_invoice.php' ?></div>
                                        <div>No HP: <?php echo $pesan['no_telp']; ?></div>
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="left strong"><?php echo $pesan['nama_tujuan']; ?></td>
                                                <td class="left"><?php echo $pesan['jml_penumpang']; ?> Orang</td>
                                                <td class="right">
                                                    <?php echo indonesian_date_only($pesan['tgl_berangkat']); ?></td>
                                                <td class="center"><?php echo indonesian_hour_only($pesan['jam']); ?>
                                                </td>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-sm-5"><br />
                                        ...
                                        <form action="../../dashboard/img/upload_bukti.php" method="POST"
                                            enctype="multipart/form-data">
                                            <div>
                                                <input type="hidden" class="form-control" name="id_transaksi"
                                                    value="<?php echo $pesan['id_pesan']; ?>">
                                            ...
                                            <div>
                                                <button type="submit" class="btn btn-rounded btn-success btn-sm">Upload
                                                    Bukti</button>
                                            </div>
                                        </form><br />
                                        <form action="simpan_invoice.php" method="POST" enctype="multipart/form-data">
                                            <div>
                                                ...
                                                <input type="hidden" class="form-control" name="id_jadwal"
                                                    value="<?php echo $pesan['id_jadwal']; ?>">
                                                <input type="hidden" class="form-control" name="jml_penumpang"
                                                    value="<?php echo $pesan['jml_penumpang']; ?>">
                                            </div>
                                            <div>
                                                <button type="submit" class="btn btn-rounded btn-primary btn-sm">Upload
                                                    Nanti</button>
                                            </div>
                                        </form>
                                        <br />
                                        <h5>
                                            ...
                                            <img src="../../img/rekbni1.png" width="200" height="20"><br />
                                            Atas Nama: <b>P.O Budiman</b>
                                        </h5><br />
                                        <p><i><small>Batas waktu pengiriman paling lambat 1 hari setelah
                                                    pemesanan.<br />
                                                    Jika melebihi waktu tersebut, pelanggan dinyatakan batal dalam
                                                    memesan.</small></i></p>
                                    </div>
                                    <?php
                                        $diskon = ($pesan['diskon']);
                            ...
                            <div class="card-footer bg-white">
                                <p class="mb-0">P.O Budiman Yogyakarta <script>
